...
### Default stats
scoreboard players set @s stats.maxHealth 40
...
scoreboard players set @s stats.knockbackResistance 4
scoreboard players set @s stats.attackDamage 13
scoreboard players set @s stats.attackSpeed -5
